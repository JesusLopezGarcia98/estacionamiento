...
//este es nuestro boton ctualizar
//<th><a href="actualizar.php?id=<?php echo $row['id']; " class="btn btn-success">Actualizar</a></th>

//<a href="actualizar.php?id=<?php echo $row['id']; " = le creamos una variable que se llama id (actualizar.php?"id=")
//esa variable va hacer igual al id de nuestra base de datos = <?php echo $row = este id['id']
//osea cada vez que le demos a actualizar un usuario nos va a traer el id de ese usuario con toda y su informacion
//gracias al select que hicimos abajo

$id=$_GET['id'];
//traeremos los datos de ese usuario cuando le demos en actualizar
    ...
    <div id="layoutSidenav">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="crud-login.php">Login</a><a class="nav-link" href="index.php">Register</a><a class="nav-link" href="index.php">Inicio</a></nav>
                                </div>
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container mt-5">
                <form role="form" method="POST" action="logica/actualizar_datos.php">
                    <div class="form-group">

                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>"/>
                    
                        <label for="inputName">Usuario</label>
                        <input type="text" class="form-control" placeholder="Enter your name" value="<?php echo $row['usuario']; ?>" name="usuario" />
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Email</label>
                        <input type="email" class="form-control" placeholder="Enter your email"  value="<?php echo $row['email']; ?>" name="email"/>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword">Telefono</label>
                        <input type="text" class="form-control" placeholder="Enter your phone"  value="<?php echo $row['telefono']; ?>" name="telefono"/>
                    </div>
                   
                    <div class="form-group">
                    <select class="form-select"  name='opcion'>
  <option selected><?php echo $row['opcion']; ?></option>
  <option>1-2 hora $100MX</option>
  <option >3-5 hora $300MX</option>
  <option>6-8 hora $500MX</option>
</select>
</div>
